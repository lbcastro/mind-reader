...
public class LDA {
	...
	public static void main(String[] args) {
		int[] group = { 1, 1, 1, 1, 2, 2, 2, 3, 3 };
		double[][] data = { { 2.95, 6.63, 3.33 }, { 2.53, 7.79, 3.88 }, { 3.57, 5.65, 3.10 },
				{ 3.16, 5.47, 3.60 }, { 2.58, 4.46, 5.10 }, { 2.16, 6.22, 5.90 }, { 3.27, 3.52, 5.50 }, 
				{ 8.13, 8.10, 7.50 }, { 7.66, 8.30, 7.80 }
		};

		LDA test = new LDA(data, group, true);
		double[] testData = { 2.81, 5.46, 5.55 };
